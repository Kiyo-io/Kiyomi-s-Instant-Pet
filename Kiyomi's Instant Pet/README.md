...
This mod removes those limits while keeping everything **fully vanilla-friendly**.
...
1. Open the Pet Config Menu.
2. ✅ Check **Allow Multiple Pets**
3. Choose pet type + name.
4. Click **Adopt Another Pet**

A new pet will spawn instantly! 🐾

To edit that pet afterward:
...
✅ Uses vanilla pet behavior & systems
